  ...
  createVehicle(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // Continue to take actions until "Exit" is selected
      });
  }
  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // push the motorbike to the vehicles array DONE
        this.vehicles.push(motorbike);
        // set the selectedVehicleVin to the vin of the motorbike DONE
        this.selectedVehicleVin = motorbike.vin;
        // perform actions on the motorbike DONE
        this.performActions();
      });
  }
